        ...
        static void Main(string[] args)
        {
            ...
            while (runProgram)
            {
                ...
                switch (selection)
                {
                    ...
                    case ("Delete a room"):
                        List<Room> showRooms = roomRepo.GetAll();
                        foreach (Room r in showRooms)
                        {
                            Console.WriteLine($"{r.Id} - {r.Name} Max Occupancy({r.MaxOccupancy})");
                        }
                        Console.Write("Which room would you like to delete? ");
                        int toDeleteRoomId = int.Parse(Console.ReadLine());
                        roomRepo.Delete(toDeleteRoomId);
                    ...
                    case ("Delete a chore"):
                        List<Chore> showChores = choreRepo.GetAll();
                        foreach (Chore c in showChores)
                        {
                            Console.WriteLine($"{c.Id} - {c.Name}");
                        }
                        Console.Write("Which chore would you like to delete? ");
                        int toDeleteChoreId = int.Parse(Console.ReadLine());
                        choreRepo.Delete(toDeleteChoreId);
